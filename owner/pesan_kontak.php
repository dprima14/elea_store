...
// Owner hanya bisa lihat & tandai — tidak bisa hapus
...
.pk-filter a.active,.pk-filter a:hover{border-color:#6b3320;color:#6b3320;background:#fff8f6;}
...
.pk-card.unread{border-left:4px solid #6b3320;}
.pk-head{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;padding:1rem 1.25rem .75rem;}
.pk-avatar{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#3d1a0a,#6b3320);display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:.9375rem;flex-shrink:0;}
...
.pk-badge.unread{background:#fff8f6;color:#6b3320;border:1px solid #f5d4cb;}
...
.pk-btn-read{background:#fff8f6;color:#6b3320;border:1px solid #f5d4cb;}
...
<div class="pk-stats">
    ...
    <div class="pk-stat">
        <div class="pk-stat-val" style="color:#6b3320;"><?= $total_belum ?></div>
