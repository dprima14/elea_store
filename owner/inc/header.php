...
$user = $_SESSION['user'];
$cfg  = ['icon'=>'<i class="fas fa-crown"></i>','label'=>'Owner','gradient'=>'linear-gradient(135deg,#3d1a0a,#6b3320)','color'=>'#6b3320'];
$menus = [
    ['key'=>'index',                 'label'=>'Dashboard',           'icon'=>'<i class="fas fa-chart-bar"></i>',  'href'=>'index.php'],
    ['key'=>'monitoring_penjualan',  'label'=>'Monitoring Penjualan','icon'=>'<i class="fas fa-chart-line"></i>', 'href'=>'monitoring_penjualan.php'],
    ['key'=>'monitoring_stok',       'label'=>'Monitoring Stok',     'icon'=>'<i class="fas fa-box"></i>',        'href'=>'monitoring_stok.php'],
...
<title><?= $page_title ?? 'Owner' ?> | Elea Store</title>
...
<div class="db-topbar">
    <div style="display:flex;align-items:center;flex:1;min-width:0;gap:.25rem;">
        ...
        <div style="min-width:0;">
            ...
            <p style="margin:0;"><?= htmlspecialchars($user['nama']) ?> · Owner</p>
        </div>
    </div>
