...
.pk-filter a.active,.pk-filter a:hover{border-color:#7a2e22;color:#7a2e22;background:#fff8f6;}
...
.pk-card.unread{border-left:4px solid #7a2e22;}
.pk-head{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;padding:1rem 1.25rem .75rem;}
.pk-avatar{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#7a2e22,#9e5848);display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:.9375rem;flex-shrink:0;}
...
.pk-badge.unread{background:#fff8f6;color:#7a2e22;border:1px solid #f5d4cb;}
...
.pk-btn-read{background:#fff8f6;color:#7a2e22;border:1px solid #f5d4cb;}
...
<div class="pk-stats">
    ...
    <div class="pk-stat">
        <div class="pk-stat-val" style="color:#7a2e22;"><?= $total_belum ?></div>
